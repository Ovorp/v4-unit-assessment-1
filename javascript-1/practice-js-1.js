...
function bigOrSmall(arr) {
  const answers = [];
  for (let i of arr) {
    i > 100? answers.push('big') : answers.push('small')
  }
  return answers;
}
//////////////////PROBLEM 13////////////////////
...
//CODE HERE
function isItBob({name}, func) {
  name === 'Bob'? func(true) : func(false);
}
//////////////////PROBLEM 17////////////////////
/*
...
//CODE HERE
function giveMeDoubles(arr, func) {
  for (let i in arr) {
    arr[i] *= 2;
  }
  func(arr)
...
function carFactory(make, model, year) {
  ...
  obj.year > 2018 ? obj.isNew = true : obj.isNew = false;
  return obj;
}